...
### Подсказка: чтобы поднять или опустить букву в верхний/нижний регистр воспользуйтесь variableName[индекс нужной вам буквы].toUpperCase() - чтобы поднять, variableName[индекс нужной вам буквы].toLowerCase() - чтобы понизить регистр буквы
